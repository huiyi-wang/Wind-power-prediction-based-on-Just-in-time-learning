...
for year in Year:
    ...
    file_name2='../A0Sample_creat/'+year+'/全年/'+str(ahead_time)+'mins/'+'Z_'+year+'All_Samples_lookback='+str(lookback)+' ahead='+str(ahead_time)+'mins sample_interval='+str(sample_interval*5)+'mins feature_num='+str(feature_num)+'Train_num=12'
